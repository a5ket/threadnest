...
// Without this, a notification published from one PM2 instance never reaches a socket
// connected to another — Socket.IO's default in-memory adapter only fans out within one process.
