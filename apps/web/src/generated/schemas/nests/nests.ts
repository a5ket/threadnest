...
export const NestCreateResponse = zod.object({
  data: zod.object({
    ...
    access: zod.object({
      ...
      isPaywalled: zod.boolean().describe('Whether the nest requires a subscription to view'),
      paywallPriceAmountCents: zod.number().nullable().describe('Subscription price in cents, if the nest is paywalled'),
      hasActiveSubscription: zod.boolean().describe('Whether the current user has an active subscription to this nest'),
      canViewNest: zod.boolean().describe('Whether the current user can view the nest'),
      canViewNestMetadata: zod.boolean().describe('Whether the current user can view the nest\'s basic info (description, member\/thread counts) even if they can\'t view its content'),
